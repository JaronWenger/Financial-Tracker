      ...
      <div className="App">
        ...
        <div className="NumberCards">
          <div className="NumberCard">
            <Number label="Net Worth" value={netWorth} dataType="money" more="Net worth is the value of assets minus liabilities, indicating an individual's financial standing by showcasing the difference between what they own and what they owe."/>
          </div>
          <div className="NumberCard">
            <Number label="Savings Rate" value={savingsRate} dataType="percent" more="The savings rate represents the portion of income that a person saves rather than spends. It reflects the proportion of earnings set aside for future use or investment."/>
          </div>
          <div className="NumberCard">
            <Number label="FIRE #" value={fireNumber} dataType="money" more="The Fire Number, based on the 4% rule, represents the total savings needed for retirement. It ensures sustainable income to maintain desired lifestyle post-retirement."/>
          </div>
        </div>
